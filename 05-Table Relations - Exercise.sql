...
ALTER TABLE `people` MODIFY COLUMN `person_id` INT PRIMARY KEY AUTO_INCREMENT;
ALTER TABLE `passports` MODIFY COLUMN `passport_id` INT PRIMARY KEY AUTO_INCREMENT, AUTO_INCREMENT=101;

ALTER TABLE `people` ADD CONSTRAINT fk_people_passport FOREIGN KEY (`passport_id`)
